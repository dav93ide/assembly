...
char *XmmVal::ToString_u8(char *s, size_t len){
    sprintf_s(s, len, "%4u %4u %4u %4u %4u %4u %4u %4u | %4u %4u %4u %4u %4u %4u %4u %4u", u8[0], u8[1], u8[2], u8[3], u8[4], u8[5], u8[6], u8[7], u8[8], u8[9], u8[10], u8[11], u8[12], u8[13], u8[14], u8[15]);
    return s;
}

char *XmmVal::ToString_u16(char *s, size_t len){
    sprintf_s(s, len, "%8u %8u %8u %8u | %8u %8u %8u %8u", u16[0], u16[1], u16[2], u16[3], u16[4], u16[5], u16[6], u16[7]);
    return s;
}
...
char *XmmVal::ToString_x8(char *s, size_t len){
    sprintf_s(s, len, "%02X %02X %02X %02X %02X %02X %02X %02X | %02X %02X %02X %02X %02X %02X %02X %02X", u8[0], u8[1], u8[2], u8[3], u8[4], u8[5], u8[6], u8[7], u8[8], u8[9], u8[10], u8[11], u8[12], u8[13], u8[14], u8[15]);
    return s;
}

char *XmmVal::ToString_x16(char *s, size_t len){
    sprintf_s(s, len, "%04X %04X %04X %04X | %04X %04X %04X %04X", u16[0], u16[1], u16[2], u16[3], u16[4], u16[5], u16[6], u16[7]);
    return s;
}
...
char *XmmVal::ToString_r64(char *s, size_t len){
    sprintf_s(s, len, "%24.12f | %24.12f", r64[0], r64[1]);
}
